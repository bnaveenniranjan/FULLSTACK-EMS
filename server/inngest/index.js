...
// send email to admin , if no response take ACTION on leave application
const leaveApplicainRemaider = inngest.createFunction(
        ...
        async () => {
          ...
          const emailPromises = absentEmployees.map((emp) => {
            ...
            sendEmail({
              ...
              haven't marked your attendance yet today.</p>
