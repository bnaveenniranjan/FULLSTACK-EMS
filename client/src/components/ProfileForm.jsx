  ...
  return (
    <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'>
        <h2 className='text-base font-medium text-slate-900 mb-6 pb-4 border-b border-slate-100 flex items-center gap-2'>
          ...
          {error && (
            <div className='bg-rose-50 text-rose-700 roundee-xl text-sm border border-rose-200 mb-6 flex items-start gap-3'>
              ...
              {initialData.isDeleted ?(
                <div className='pt-2'>
                  <div className='p-4 bg-rose-50 border border-rose-200 rounded-xl text-center'>
                    ...
                    <p className=''>you can no longer update your profile.</p>
                  </div>
