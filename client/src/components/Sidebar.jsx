...
const Sidebar = () => {
    ...
    //import dummy data from assets and set the user name in the sidebar
    useEffect(() => {
        setUserName(
    ...
    return (
        <>
            ...
            {/* Sidebar - desktop */}
            <aside className='hidden lg:flex flex-col w-65 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-950 text-white shrink-0 border-r border-white/10'>
                {sidebarContent}
            </aside>
