...
import { DEPARTMENTS } from '../assets/assets/assets'
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
        ...
        <div className="card p-5 sm:p-6">
            ...
            <div className=" grid grid-cols-1:grid-cols-2 gap-5 text-sm text-slate-700">
                <div>
     ...
     {isEditMode && (
        ...
        <div>
            ...
            <select name="employmentStatus"   defaultValue={initialData?.EmployeeStatus}>
         ...
         <div className="card p-5 sm:p-6">
            ...
            <div className=" grid grid-cols-1:grid-cols-2 gap-5 text-sm text-slate-700">
                ...
                <div>
                        ...
                        <select type="role" defaultValue={initialData?.user?.role || "EMPLOYEE"}>
       ...
       <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-2">
        ...
        <button type="submit" disabled={loading} className="btn-primary flex items-center justify-center">
                {loading && <Loader2Icon className="w-4 h-4 mr-2 aniamte-spin"/>}
