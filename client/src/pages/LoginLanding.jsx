...
<diV className="space-y-4">
      {portalOptions.map((portal)=>(
       ...
       className="group block bg-slate-50 border border-slate-200 rounded-lg p-5 sm: p-6transition-all duration-30hover:border-indigo-400 hover:bg-indigo-50">
  ...
  {/*Footer*/}
   <div className="mt-12 text-center md:text-left-left text-sm text-slate">
    <p>
      {new Date().getFullYear()} technovert. All rights reserved.
    </p>
   </div>
</div>
    </div>
